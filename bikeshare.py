...
def get_filters(city, month, day):
    ...
    month = input(
        'Please enter all for no month filter or January through June to see data for the month:\n').lower()
    while month not in MONTH_DATA:
        print('Oops, wrong month name! Please enter a valid month name:\n')
        month = input('Please enter a valid month name:\n').lower()
    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    day = input(
        'Please enter all for no day filter or a day of the week, Sunday through Saturday to filter by the day\n').lower()
...
def load_data(city, month, day):
    ...
    # TO DO: Extract month and day of the week from Start Time column to create new month and day of the week columns
